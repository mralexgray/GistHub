...
#import "/sd/AtoZ.framework/AtoZ/AZSugar.h"
...
{
    NSDictionary *paramsDictionary = $map( @"state" , @"closed" );//@{ @"state" : @"closed" };
...
{
    NSDictionary *paramsDictionary =$map( @"state" ,@"open");//@{ @"state" : @"open" };
	[self invoke:^(id self){[self sendRequest:[NSString stringWithFormat:@"repos/%@/issues/%ld", repositoryPath, issueNumber] requestType:UAGithubIssueEditRequest responseType:UAGithubIssueResponse withParameters:paramsDictionary error:nil];} success:successBlock failure:failureBlock];
}
...
{
    NSDictionary *params  = $map( @"milestone", [NSString stringWithFormat:@"%ld", milestoneNumber] );
	//= @{ @"milestone" : [NSString stringWithFormat:@"%ld", milestoneNumber] };
